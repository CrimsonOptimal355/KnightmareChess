...
bool isMovemakeKingCheck(int startRow, int startCol, int endRow, int endCol, char sourcepiece, char targetpiece);
...
bool isValidCastling(int startRow, int startCol, int endRow, int endCol, char sourcePiece, bool whiteKingMoved,
                     bool blackKingMoved, bool whiteLeftRookMoved, bool whiteRightRookMoved,
